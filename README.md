...
| [astravaultnet](apps/astravaultnet/) | `ghcr.io/astrateam-net/astravaultnet` | `0.43.121` |
...
| [cnpg-pg-cron](apps/cnpg-pg-cron/) | `ghcr.io/astrateam-net/cnpg-pg-cron` | `1.6.7` |
| [gerbil-traefik-s6](apps/gerbil-traefik-s6/) | `ghcr.io/astrateam-net/gerbil-traefik-s6` | `1.5.0` |
